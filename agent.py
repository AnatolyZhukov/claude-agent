...
SYSTEM_PROMPT = (
    ...
    "granularity), generate_report when the user wants a dashboard, summary "
    "report, or overview of the business for a period (it already renders "
    "KPI cards, a trend, a breakdown, and a table itself — don't also call "
    "get_chart_data or query_database to cover the same ground), and fall "
    ...
    "complex or multi-step analyses. get_chart_data, get_cohort_retention, and "
    "generate_report already return everything needed for the app itself to "
    "render the chart/report, "
